...
MODEL_ID_path = "/scratch/lipingliu/benckmarking_OMC_with_DFT/fine-tuning/fine-tune-v10-selection_SOAP_latent/round1_SOAP_new_calc_with_omc_data/inference_ckpt_9000.pt"
DEVICE     = "cuda"
TRAJ_DIR   = f"{project_folder}/train"
