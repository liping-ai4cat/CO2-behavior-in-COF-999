...
# ---------------- User settings ----------------
project_folder = "/scratch/lipingliu/benckmarking_OMC_with_DFT/"
TASK       = "omc"
MODEL_name = "uma-s"
MODEL_ID   = f"{MODEL_name}-1p1"
MODEL_ID_path = "/home/lipingliu/.cache/fairchem/models--facebook--UMA/snapshots/abaa274e3612b2cfcc5be2d900ffa2a03cb42ee7/checkpoints/uma-s-1p1.pt"
DEVICE     = "cuda"
TRAJ_DIR   = f"{project_folder}/new_benchmarking_true_test"
