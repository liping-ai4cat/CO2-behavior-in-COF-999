...
# --- SETTINGS ---
R_SCALE = 1.3
REF_PATH = "/scratch/lipingliu/benckmarking_OMC_with_DFT/metadynamics_using_uma/fine-tuned-uma-s-v10-round2-SOAP-v3/CO2-single-COF-999-dry-rerun/plus_CO2.traj"
CSV_PATH = "/scratch/lipingliu/benckmarking_OMC_with_DFT/metadynamics_using_uma/fine-tuned-uma-s-v10-round2-SOAP-v3/CO2-single-COF-999-dry-rerun_restart/analysis_output/v7_all/job_results_updated.csv"
...
def process_trajectory(args):
    ...
    try:
        ...
        # List to store distance data: [JobID, Frame, idx_plus, idx_minus, distance]
        dist_records = []
        ...
        for f_idx, atoms in enumerate(traj):
            ...
            # Calculate distances if coexisting
...
def main():
    ...
    if final_stats:
        ...
        print(f"\nDone! Summary and distance files saved.")
    else:
