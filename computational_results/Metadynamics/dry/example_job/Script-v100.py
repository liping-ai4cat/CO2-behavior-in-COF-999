...
# key input
C_idx = 1752 + 1  # the index of intersted C in gas phase CO2
...
structure_dir = "/scratch/lipingliu/benckmarking_OMC_with_DFT/metadynamics_using_uma/fine-tuned-uma-s-v10-round2-SOAP-v3/CO2-single-COF-999-dry"
