...
DEVICE = "cuda"
file_folder = '/scratch/lipingliu/mutilayers_all/fine-tune-v9/COF-999/112'
...
if __name__ == "__main__":
    ...
    atoms_list = read(f"/scratch/lipingliu/benckmarking_OMC_with_DFT/systematic_benchmarking_unit_cell/get_systems_seperately_for_benchmarking/relaxation/COF999_pristine_2branches_pristine_g1.traj", index="-1")
    ...
    predictor = load_predict_unit(MODEL_ID_path, device=DEVICE, workers=4, inference_settings="turbo")
