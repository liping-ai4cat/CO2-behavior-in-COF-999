...
DEVICE = "cuda"
file_folder = '/scratch/lipingliu/benckmarking_OMC_with_DFT/mutilayers_all/fine-tune-v10-round2-SOAP/COF-999-humid-v2'
...
if __name__ == "__main__":
    # 1. Read input
    atoms_list = read(f"{file_folder}/64H2O_restart/all_relaxed_atoms.traj", index=":")
